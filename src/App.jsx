  ...
  return (
    <>
      <div className="text-newBlack font-poppins">
        <Header />
        <div id="about" className="h-full lg:h-screen p-10 lg:p-0 flex flex-col lg:flex-row items-center justify-center gap-5 lg:gap-0 md:gap-10 lg:justify-between">
          <div className="flex flex-col gap-3 p-5 md:p-0 lg:p-0 md:pl-24 lg:pl-24">
            <h1 className="text-orangePrimary text-3xl md:text-4xl lg:text-4xl font-bold"> SOBRE </h1>
            ...
            <p className="text-xl md:text-2xl lg:text-2xl pt-2 md:w-10/12 lg:w-10/12">
              ...
              leitura onde você pode desapegar de livros que já leu e {' '}
              receber novas aventuras literárias em troca. Participe do {' '}
              nosso clube de troca de livros e expanda seus horizontes {' '}
              literários de maneira divertida e sustentável.{' '}
            </p>
          </div>
          ...
          <div className="flex flex-col gap-5 bg-orangeThird rounded-md h-6/12 lg:h-72 w-80 md:w-4/6 lg:w-2/6 p-5">
            <div className="flex gap-5 items-center">
              ...
              <p className="md:text-lg lg:text-lg">
                {' '}
                Desapegue - Escolha um livro da sua estante que você gostaria de
                compartilhar.{' '}
              </p>
            </div>
            <div className="flex gap-5 items-center">
            ...
            <div className="flex gap-5 items-center">
              ...
              <p className="md:text-lg lg:text-lg">
                {' '}
                Receba - Receba um novo livro que alguém enviou para você. Você
                pode escolher o gênero que prefere ou optar por uma surpresa!{' '}
              </p>
            </div>
          </div>
        </div>
        ...
        <div
          id="clients"
          className="bg-orangeSecundary p-10 lg:p-0 h-full lg:h-screen flex flex-col justify-center md:gap-9 lg:gap-9 items-center"
        >
          ...
          <div className="flex flex-col lg:flex-row lg:w-9/12 gap-5 lg:gap-0 lg:justify-around">
            <div>
              <div className="border md:h-64 lg:h-64 p-5 w-80 border-orangePrimary rounded-md">
                <div className="flex items-center gap-3">
                  <img src={maria} className="h-12 md:h-20 lg:h-20" alt="Foto da Maria" />
                  <p className="text-lg font-medium"> Maria S </p>
                </div>
                <p className="pt-3 text-lg">
                  {' '}
                  Participar do Amigo Literário foi uma experiência incrível!
                  Recebi um livro que nunca teria escolhido por conta própria e
                  adorei.{' '}
                </p>
              </div>
            </div>
            <div>
              <div className="border md:h-64 lg:h-64 p-5 w-80 border-orangePrimary rounded-md">
                <div className="flex items-center gap-3">
                  <img src={joao} className="h-12 md:h-20 lg:h-20" alt="Foto do João" />
            ...
            <div>
              <div className="border md:h-64 lg:h-64 p-5 w-80 border-orangePrimary rounded-md">
                <div className="flex items-center gap-3">
                  <img src={ana} className="h-12 md:h-20 lg:h-20" alt="Foto da Ana" />
                  <p className="text-lg font-medium"> Ana L </p>
                </div>
                <p className="pt-3 text-lg">
                  {' '}
                  Adoro a expectativa de esperar um novo livro surpresa chegar.
        ...
        >
          <div className="join-content flex flex-col md:flex-row lg:flex-row gap-3 w-full items-center md:justify-around lg:justify-around">
